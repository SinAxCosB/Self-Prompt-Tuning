...
def create_model(args, num_class):
    if args.tuning_type in ["fine-tuning", "linear"]:
        ...
        if args.tuning_type == "linear":
            ...
            assert requires_grad == ['head.weight', 'head.bias']
        ...
        model = Models.__dict__[args.model_name](num_prompts=args.num_prompts, prompt_init=prompt, drop_path_rate=args.drop_path)
